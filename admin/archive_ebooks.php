        ...
        <section class="col-lg-12 connectedSortable">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-pencil"></i> Archive E-Books</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
<?php
  $query=mysqli_query($con,"select * from ebooks where book_id='$get_id'")or die(mysqli_error($con));
...
mysqli_query($con,"delete from ebooks where book_id = '$get_id' ")or die(mysql_error());
