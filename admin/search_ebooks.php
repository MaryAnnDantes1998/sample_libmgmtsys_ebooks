...
?>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                                <form method="GET" class="form-horizontal">
                                    <center><h3><strong>Search E-Books</strong></h3></center>
    ...
    <?php
        ...
        LEFT JOIN tbl_moa ON tbl_moa.moa_id = ebooks.moa_id
        LEFT JOIN tbl_publishers ON tbl_publishers.publisher_id = ebooks.publisher_id
        LEFT JOIN tbl_placeofpublications ON tbl_placeofpublications.pop_id = ebooks.pop_id
    ...
    ?>
                            ...
                            <?php if($_SESSION['role'] == "Administrator"){ ?>   
                                <td>
                    <a class="btn btn-default" for="ViewAdmin" href="view_ebooks.php<?php echo '?book_id='.$id; ?>">
                                        <i class="fa fa-eye"></i> View
                                    </a>
                                    <a class="btn btn-primary" for="ViewAdmin" href="edit_ebooks.php<?php echo '?book_id='.$id; ?>">
                                    <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <a class="btn btn-success" for="ViewAdmin" href="archive_ebooks.php<?php echo '?book_id='.$id; ?>">
                                   ...
                                   <a class="btn btn-danger" for="DeleteBook" href="#delete<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <a href="delete_ebooks.php<?php echo '?book_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
                                                </div>
                                        </div>
                                        </div>
                                    </div>
